...
import readFasta
# fastasFile = re.sub('codes$', '', os.path.split(os.path.realpath(__file__))[0]) + r'\data\test.txt' if platform.system() == 'Windows' else re.sub('codes$', '', os.path.split(os.path.realpath(__file__))[0]) + '/data/test.txt'
# fastas = readFasta.readFasta(fastasFile)
fastasFile = re.sub('codes$', '', os.path.split(os.path.realpath(__file__))[0]) + r'\train_hum+.txt' if platform.system() == 'Windows' else re.sub('codes$', '', os.path.split(os.path.realpath(__file__))[0]) + '/train_hum+.txt'
fastas = readFasta.readFasta(fastasFile)
fastasFile1 = re.sub('codes$', '', os.path.split(os.path.realpath(__file__))[0]) + r'\train_hum-.txt' if platform.system() == 'Windows' else re.sub('codes$', '', os.path.split(os.path.realpath(__file__))[0]) + '/train_hum-.txt'
...
#     train_p_data = AAC(fastas)
#     train_n_data = AAC(fastas1)
#
#
...
#         rf = RandomForestClassifier(n_estimators=3789, max_depth=19, min_samples_leaf=82, min_samples_split=4,
