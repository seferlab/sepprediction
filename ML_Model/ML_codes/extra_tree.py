...
def tudou(CSV,target,xianshi=True):
    ...
    # 建立模型
    # gc = ExtraTreeClassifier(n_estimators=500, n_jobs=-1, random_state=666)
    gc = ExtraTreesClassifier(n_estimators=500, bootstrap=True, oob_score=True, random_state=666, n_jobs=-1)
