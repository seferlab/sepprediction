...
def tudou(CSV,target,xianshi=True):
    ...
    #
    # )
    kn_ = CatBoostClassifier(iterations=500,verbose=False,thread_count=40)
    # kn_ = CatBoostClassifier()
    # model_path = "./web_model/human_model"
    # kn_ = kn_.load_model(model_path)
    # 训练
    kn_.fit(x_train, y_train)
    # kn_.save_model(fname="./web_model/rat_model")
    ...
    name = 'D:/xuexi/ORF/试验/First_kind/RAT/TESTCatboost_RAT_SEPs_sORFs_Finally_features'
